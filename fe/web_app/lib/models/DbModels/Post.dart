class Post
{
  ...
  Post(this._id, this._title, this._description, this._userEntityID, this._date, this._categoryID, this._latitude, this._longitude, this._endDate, this._typeID);
  Post.withOutId(this._title, this._description, this._userEntityID, this._date,  this._categoryID, this._latitude, this._longitude, this._endDate, this._typeID);
  Post.institutionPost(this._description, this._userEntityID, this._cityID, this._date, this._typeID);
